...
date: 2020-02-03T21:55:42+00:00
categories: ["jekyll"]
---
...
1. Install Jekyll: [Jekyll installation](https://jekyllrb.com/docs/installation/#guides)
2. Create your GitHub Pages page: [GitHub Pages guide](https://guides.github.com/features/pages/#setup) (follow up to the point where they start talking about choosing a theme - you won't need that). Make sure to name your repo: **yourname.github.io**
3. Make sure you have git installed on your machine: [Git Installation](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git) (just select your OS and download the installer).
4. Having git installed open a new terminal (or cmd.exe) and make sure to check that git is installed:
   `git --version`
5. Clone your repo that you created in step `2` by logging to GitHub and going to your newly created repo and copying the repo URL:  
